...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hours.amount'
        db.delete_column('internal_hours', 'amount')

        # Adding field 'Hours.hours'
        db.add_column('internal_hours', 'hours',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Hours.amount'
        raise RuntimeError("Cannot reverse this migration. 'Hours.amount' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Hours.amount'
        db.add_column('internal_hours', 'amount',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)

        # Deleting field 'Hours.hours'
        db.delete_column('internal_hours', 'hours')
