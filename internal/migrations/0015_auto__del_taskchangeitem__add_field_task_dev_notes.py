...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.dev_notes'
        db.add_column('internal_task', 'dev_notes',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Task.dev_notes'
        db.delete_column('internal_task', 'dev_notes')
    ...
    models = {
        ...
        'internal.hours': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'payment': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['internal.Payment']"}),
