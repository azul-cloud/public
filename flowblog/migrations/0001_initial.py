...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tag'
        db.create_table('flowblog_tag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('flowblog', ['Tag'])
        ...
        db.create_table('flowblog_post', (
            ...
            ('heading', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True, null=True)),
    ...
    models = {
        ...
        'flowblog.post': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['flowblog.Tag']", 'blank': 'True', 'symmetrical': 'False'}),
