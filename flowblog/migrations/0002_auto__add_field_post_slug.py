...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('flowblog_post', 'slug',
                      self.gf('django.db.models.fields.SlugField')(blank=True, default='', max_length=50),
                      keep_default=False)

        # save all the existing posts to update the slug with new save function
    ...
    def backwards(self, orm):
        ...
        db.delete_column('flowblog_post', 'slug')
    ...
    models = {
        ...
        'flowblog.post': {
            ...
            'heading': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '150'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'blank': 'True', 'max_length': '50'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['flowblog.Tag']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
